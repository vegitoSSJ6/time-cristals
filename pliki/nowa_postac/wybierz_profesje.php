...
else{ if($rekord_p['nazwa']=="Wiedzmin"||$rekord_p['nazwa']=="Polbog"){print"<TR><TD><A HREF=\"index.php?co=wybierz_charakter&user=".$_GET['user']."&haslo=".$_GET['haslo']."&profesja1=".$rekord_p['nazwa']."\">WYBIERZ</A></TD><TD><CENTER><img src=".$rekord_p['plik_gif']."></CENTER></TD><TD>";
