...
elseif($_GET['co']=="wybierz_charakter"){$tytul="Tworzenie Postaci - Wybor Charakteru"; naglowek($tytul); if($_GET['profesja']=="Polbog"||$_GET['profesja']=="Wiedzmin"||$_GET['profesja']=="Statysta"||$_GET['profesja']=="Drapieznik"||$_GET['profesja']=="Wszystkozerca"||$_GET['profesja']=="Roslinozerca"){przypisz_profesje1($_GET['user'], $_GET['profesja']);}
