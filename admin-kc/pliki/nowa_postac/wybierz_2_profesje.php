<?
  ...
  print("</b></td></tr></table></legend><TABLE CELLPADING=4 BORDER=1 align=\"right\"><TR><TD rowspan=2>Wspolczynniki Podstawowe :</TD><TD><B>ZW</B></TD><TD><B>SF</B></TD><TD><B>ZR</B></TD><TD><B>SZ</B></TD><TD><B>INT</B></TD><TD><B>MD</B></TD><TD><B>UM</B></TD><TD><B>CH</B></TD><TD><B>PR</B></TD><TD><B>WI</B></TD></TR><TR>");
  ...
  while($rekord_p2=mysql_fetch_assoc($wynik))
   {if($rekord_p2['nazwa']==$rekord_p1['nazwa']||$rekord_p2['nazwa']=="Wiedzmin"||$rekord_p2['nazwa']=="Polbog"){}
    ...
    elseif($rekord_p2['nazwa']=="Rycerz"&&($rekord['tytul']=="El"||$rekord['tytul']=="")&&($rasa=="Krasnolud"||$rasa=="Gnom"||$rasa=="Hobbit")){}
    elseif($rekord_p2['nazwa']=="Paladyn"&&($rekord['tytul']=="El"||$rekord['tytul']=="")&&($rasa=="Krasnolud"||$rasa=="Gnom"||$rasa=="Hobbit")){}
    elseif($rekord_p2['nazwa']=="Czarny Rycerz"&&($rekord['tytul']=="El"||$rekord['tytul']=="")&&($rasa=="Krasnolud"||$rasa=="Gnom"||$rasa=="Hobbit"||$rasa=="Reptylion")){}
